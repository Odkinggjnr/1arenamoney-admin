...
const questions = [
  "What gas do humans exhale when breathing out?",
...
export default function ServerMonitor16() {
  ...
  const [logs, setLogs] = useState([
    { time: new Date().toLocaleTimeString(), msg: '[SYSTEM] Monitoring started for $15 Room - Server 1' }
  ]);
