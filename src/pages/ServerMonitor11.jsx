...
const questions = [
  ...
  "Which animal is known to have fingerprints like humans?",
  "What is the main ingredient in guacamole?",
  "Who painted the Mona Lisa?",
  "What planet is nicknamed the 'Morning Star'?",
...
export default function ServerMonitor11() {
  ...
  const [logs, setLogs] = useState([
    { time: new Date().toLocaleTimeString(), msg: '[SYSTEM] Monitoring started for $10 Room - Server 1' }
  ]);
      ...
      >
        ...
        >
          <motion.img
            ...
            alt="Logo"
            className="h-16 md:h-20 mx-auto mb-4 rounded-xl shadow-2xl shadow-purple-500/20"
          />
        ...
        >
          ...
          >
            ...
            >
              ...
              <motion.p 
                ...
                initial={{ scale: 1.2, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                className="text-3xl font-bold bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent"
              >
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-sm p-5 rounded-2xl mb-6 border border-purple-500/20"
          >
            <p className="text-sm text-purple-400 mb-2 font-semibold">Current Question</p>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={handleBack}
            className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-3 rounded-full font-semibold shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 transition-shadow"
          >
