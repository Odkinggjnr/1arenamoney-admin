...
const questions = [
  ...
  "In what year was Bitcoin launched?",
  "What does 'CPU' stand for in computers?",
  "Which social media platform was founded first?",
  "What programming language is primarily used for Android apps?",
  "Who is known as the father of artificial intelligence?",
  "Which company developed the PlayStation console?",
  "What year did Google officially launch Gmail?",
  "What is the name of Tesla's humanoid robot project?",
  "Which company owns Instagram?",
  "What is the world's most popular web browser as of 2025?",
  "Which planet is known as the Red Planet?",
  "How many bits make up one byte?",
  "What is the fastest land animal on Earth?",
  "Which element's chemical symbol is 'Au'?"
];
...
export default function ServerMonitor9() {
  ...
  const [logs, setLogs] = useState([
    { time: new Date().toLocaleTimeString(), msg: '[SYSTEM] Monitoring started for $5 Room - Server 4' }
  ]);
