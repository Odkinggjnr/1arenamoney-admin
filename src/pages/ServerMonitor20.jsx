...
const questions = [
  ...
  "Which animal is famous for changing colors?",
  ...
  "Which gas is essential for breathing in humans?",
  "Which planet is famous for its red color?"
];
...
export default function ServerMonitor20() {
  ...
  const [logs, setLogs] = useState([
    { time: new Date().toLocaleTimeString(), msg: '[SYSTEM] Monitoring started for $15 Room - Server 5' }
  ]);
      ...
      >
        ...
        >
          <motion.img
            ...
            alt="Logo"
            className="h-16 md:h-20 mx-auto mb-4 rounded-xl shadow-2xl shadow-amber-500/20"
          />
          <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-amber-400 to-yellow-400 bg-clip-text text-transparent">
        ...
        >
          ...
          >
            ...
            >
              ...
              <motion.p 
                ...
                className="text-3xl font-bold bg-gradient-to-r from-amber-400 to-yellow-400 bg-clip-text text-transparent"
              >
                {serverData.players}
              </motion.p>
            </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 backdrop-blur-sm p-5 rounded-2xl mb-6 border border-amber-500/20"
          >
            <p className="text-sm text-amber-400 mb-2 font-semibold">Current Question</p>
            ...
            >
              <AnimatePresence initial={false}>
                {logs.map((log, index) => (
                  ...
                  >
                    <span className="text-amber-400">[{log.time}]</span> {log.msg}
                  </motion.div>
                ))}
              </AnimatePresence>
            </div>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={handleBack}
            className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-yellow-500 px-8 py-3 rounded-full font-semibold shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50 transition-shadow"
          >
