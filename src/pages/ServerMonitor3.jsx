...
const questions = [
  ...
  "Which social media platform uses the logo of a ghost?",
...
export default function ServerMonitor3() {
  ...
  const [logs, setLogs] = useState([
    { time: new Date().toLocaleTimeString(), msg: '[SYSTEM] Monitoring started for $1 Room - Server 3' }
  ]);
          ...
          >
            ...
            >
              ...
              <motion.p 
                ...
                initial={{ scale: 1.2, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                className={`text-3xl font-bold ${serverData.time <= 3 ? 'text-red-400 animate-pulse' : 'bg-linear-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent'}`}
              >
                {serverData.time}s
              </motion.p>
            </motion.div>
